...
GS_StatWeights = 
{
	...
	["ROGUE"] = {
		...
		["Weapon Skill"] = 8.7,
		--weapon dps--
		["INVTYPE_WEAPONMAINHAND"]= 4.5,
		["INVTYPE_WEAPONOFFHAND"] = 2.6,
		["Stamina"] = 0.14,
		["NormalizationFactor"] = 801
	},
	["SHAMAN"] = {
		["Healing"] = 1,
		["SpellCrit"] = 10,
	...
	["WARLOCK"] = {
		...
		["Intellect"] = 0.18,
		["Stamina"] = 0.05,
		["NormalizationFactor"] = 347
	},
	--check this, might be stated for too late in progression--
	["WARRIOR"] = {
		["Ap"] = 0.43,
		...
		["Weapon Skill"] = 15.5,
		--weapon dps--
		["INVTYPE_2HWEAPON"]= 4.77,
		["INVTYPE_WEAPONMAINHAND"] = 4.31,
		["INVTYPE_WEAPONOFFHAND"] = 1.69,
		["Stamina"] = 0.12,
		["NormalizationFactor"] = 695
	}
}


-- ilvl comp for prot war and trinkets, weights too difficult to determine--

--backer info for original Gearscore, implemenation removed due to differing realm names
--[[
GS_Special = {
